  ...
  initMod() {
    (function () {
      ...
      let multiplayer = {
        ...
        canUserJoin(user) {
          return (
            this.userIsOnMyVersion(user) &&
            !this.userIsBanned(user)
          );
        },
          ...
          let addTab = (name, content) => {
            ...
            tab.onclick = () => {
              ...
              for (let i = 0; i < tabs.length; i++) {
                ...
                tabs[i].style.backgroundColor = "rgba(255,255,255,1)";
        ...
        updateUserList(force = false) {
          ...
          let updateUserElementData = (
            ...
            if (!isMe) {
              userElement.muteButton.innerHTML = this.userIsMuted(connection.id)? "Unmute" : "Mute";
            }
            // set buttons
            if (this.isHost && !isMe) {
          ...
          if (this.roomUsers && this.roomUsers.length > 0) {
            this.roomUsers.forEach((user) => {
              if (user.connection && !user.connection.data)
        ...
        updateBanlist() {
          ...
          let updateUserElementData = (
            ...
            userElement.extraDataDiv.innerText = (
                (user.username === user.initialUsername) ?
                "" : "(" + user.initialUsername + ") - "
              ) + " Type: " + (type === "ban" ? "Session Ban" : "Perma Ban");
            userElement.iconElement.src = getSkinIconFromSkinName(user.skin);
      ...
      addScript("//unpkg.com/peerjs@1.3.1/dist/peerjs.min.js", "peerJs", () => {
